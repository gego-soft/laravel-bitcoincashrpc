...
namespace Gegosoft\Bitcoincash;
...
class Client
{
    ...
    public function __construct($config = [])
    {
        ...
        $handlerStack->push(
            Middleware::mapResponse(function (ResponseInterface $response) {
                return BitcoincashdResponse::createFrom($response);
            }),
            'json_response'
        );
    ...
    public function request($method, $params = [])
    {
          ...
          if(count($params)>0)
           {
            ...
            if ($response->hasError()) {
                ...
                throw new Exceptions\BitcoincashdException($response->error());
            }
            ...
            if (
                ...
                throw new Exceptions\BitcoincashdException($exception->getResponse()->error());
            }
        ...
        } catch (Exceptions\BitcoincashdException $exception) {
            throw $exception;
        }
    }
        ...
        callable $onRejected = null)
    {
        ...
        $promise->then(
            function (ResponseInterface $response) use ($onFullfiled) {
                $error = null;
                if ($response->hasError()) {
                    $error = new Exceptions\BitcoincashdException($response->error());
                }
            ...
            function (RequestException $exception) use ($onRejected) {
                if (
                    ...
                    $exception = new Exceptions\BitcoincashdException(
